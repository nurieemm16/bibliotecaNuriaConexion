...
public class LibroDAO {
    ...
    //Método para ACTUALIZAR la disponibilidad de un LIBRO a FALSE.
    public static void librosDevueltos2(boolean newDispo){
        //String query = "UPDATE Libro l INNER JOIN Usuario_LibrosPrestados ulp ON l.titulo = ulp.titulo SET l.disponibilidad = ? WHERE ulp.titulo IS NOT NULL;";
        //String query = "UPDATE Libro l SET l.disponibilidad = ? WHERE l.disponibilidad = false;";
        String query = "UPDATE Libro l INNER JOIN Usuario_LibrosPrestados ulp ON l.titulo = ulp.titulo SET l.disponibilidad = ? WHERE ulp.titulo IS NULL;";
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Oh, oh... Error con el libroDevuelto2.");
            e.printStackTrace();
        }
    }
    ...
    public static void librosDevueltos(int id_Libro, boolean newDispo){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Oh, oh... Error con el librosDevueltos");
            e.printStackTrace();
        }
    }
    ...
    public static void cambiarDisponibiliad(String titulo, boolean dispo){
        ...
        try(Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Disponibilidad del libro " + titulo + " es la siguiente: " + dispo);
